...
| Release state | `release/current/` is the obsolete SHA-bound artifact for `32275776039ebf39f40e7d8deef13417d2625f23`; no release has been generated from the migration-004 fix yet. Production remains on the active `f604148b836cbbc54956ce33b8eb08e92ccaebd3` release. | artifact-observed plus current task boundary |
...
| Current phase | Migration-004 retry-idempotency fix is committed and pushed as `68545e45b4ca8981a190fd34c728811395aae8cc`; production remains on `f604148b836cbbc54956ce33b8eb08e92ccaebd3` with passwords unchanged and migration `004` inactive. | current source task plus directly verified prior production state |
| Next action | Complete the read-only production database compatibility check before generating a release. Do not generate, deploy, apply migration `004`, or rotate credentials until compatibility and the corresponding approvals are confirmed. | current task boundary |
