...
| Current phase | Admin session-epoch and rotation-CLI hardening is committed, pushed, and locally released as `455032b7e5b3ebe3b8921c3da4af1f1a39f60ad1`; production remains on `f604148b836cbbc54956ce33b8eb08e92ccaebd3` with passwords unchanged and migration `004` inactive. | current release task plus directly verified prior production state |
